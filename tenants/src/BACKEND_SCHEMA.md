...
## Table of Contents
1. [User/Tenant Entity](#usertenant-entity)
2. [Bills Entity](#bills-entity)
3. [Complaints Entity](#complaints-entity)
4. [Feedback Entity](#feedback-entity)
5. [Payments Entity](#payments-entity)
6. [Notifications Entity](#notifications-entity)
