...
import { Bell, User, X, Check, AlertCircle, DollarSign, FileText, MessageSquare, Info, Sun, Moon, Monitor } from 'lucide-react';
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <Popover open={isNotificationOpen} onOpenChange={setIsNotificationOpen}>
            <PopoverTrigger asChild>
              <Button variant="ghost" size="icon" className="relative dark:text-gray-300 hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all">
                <Bell className="h-5 w-5" />
                {unreadCount > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 flex items-center justify-center min-w-[20px] h-[20px] bg-gradient-to-r from-red-500 to-red-600 text-white rounded-full text-xs px-1.5 shadow-lg animate-pulse">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="dark:bg-gray-800/95 dark:border-gray-700/50 backdrop-blur-xl border-0 shadow-2xl w-56">
              ...
              <DropdownMenuSeparator className="dark:bg-gray-700/50" />
              <DropdownMenuItem className="dark:text-gray-300 dark:hover:bg-gray-700/50 cursor-pointer text-red-600 dark:text-red-400">
                Logout
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
