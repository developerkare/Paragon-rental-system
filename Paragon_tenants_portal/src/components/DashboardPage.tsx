    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground flex items-center gap-2">
          ...
          <span className="inline-flex items-center gap-1 text-xs bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded-full">
      ...
      <Card className="dark:bg-gray-800/50 dark:border-gray-700/50 border-0 shadow-2xl shadow-gray-200/80 dark:shadow-none backdrop-blur-sm overflow-hidden relative">
        ...
        <CardHeader className="relative border-b border-gray-100 dark:border-gray-700/50 bg-gradient-to-r from-transparent to-blue-50/50 dark:to-blue-900/20">
          <div className="flex items-center justify-between">
            <CardTitle className="dark:text-gray-100 flex items-center gap-3">
              <div className="h-8 w-1.5 bg-gradient-to-b from-blue-500 to-blue-600 rounded-full shadow-lg shadow-blue-500/50" />
        ...
        <CardContent className="relative pt-6">
          <div className="space-y-3">
            {recentBills.map((bill, index) => (
              <div 
                key={bill.id} 
                className="group relative flex items-center justify-between p-5 border border-gray-200/80 dark:border-gray-700/50 rounded-2xl hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-blue-100/30 dark:hover:from-blue-950/20 dark:hover:to-blue-900/20 dark:bg-gray-800/40 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 dark:hover:shadow-blue-500/5 hover:border-blue-500/30 dark:hover:border-blue-500/50 cursor-pointer animate-in slide-in-from-left duration-500 hover:-translate-y-0.5"
                style={{ animationDelay: `${index * 100}ms` }}
