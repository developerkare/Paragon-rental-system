import { LayoutDashboard, FileText, UserPlus, MessageSquare, MessageCircle, CreditCard, Menu, X, Phone, Mail, MessageCircleMore, Clock, FileCheck } from 'lucide-react';
    ...
    <>
      ...
      >
        <div className="h-full flex flex-col">
          <div className="p-6 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700">
          ...
          <div className="p-4 border-t border-gray-200/50 dark:border-gray-700/50">
            <button 
              ...
              className="w-full p-4 rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-600/10 dark:from-blue-500/20 dark:to-blue-600/20 border border-blue-500/20 dark:border-blue-500/30 hover:shadow-lg hover:scale-[1.02] transition-all duration-200 text-left group cursor-pointer"
            >
        ...
        <DialogContent className="sm:max-w-[500px] dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="space-y-3 mt-4">
            ...
            <button
              ...
              className="w-full flex items-center gap-4 p-4 rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 hover:border-blue-500 dark:hover:border-blue-500 transition-all duration-200 group"
            >
            ...
            {/* Business Hours */}
            <div className="mt-4 p-4 rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-600/10 dark:from-blue-500/20 dark:to-blue-600/20 border border-blue-500/20 dark:border-blue-500/30">
